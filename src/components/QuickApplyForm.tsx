    ...
    >
      ...
      <label className="flex items-start gap-2.5 mt-5 cursor-pointer">
        ...
        <span className="text-rogue-silver/80 text-xs leading-relaxed">
          I agree to receive SMS notifications regarding my application from Rogue Capital Group
          Corp. Reply STOP to opt-out; Reply HELP for help; Message and data rates apply; Messaging
          frequency may vary. See{' '}
