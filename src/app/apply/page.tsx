            ...
            <div className="mt-12 bg-rogue-dark/50 border border-white/5 rounded-2xl p-8">
              ...
              <div className="mt-6 pt-6 border-t border-white/5">
                <p className="text-rogue-silver text-sm">
                  Questions? Call us: <a href="tel:7737183282" className="text-rogue-red hover:underline">(773) 718-3282</a> or <a href="tel:7737183354" className="text-rogue-red hover:underline">(773) 718-3354</a>
                </p>
              </div>
            </div>
          </ScrollReveal>
